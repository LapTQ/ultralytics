...
class BaseTrainer:
    ...
    def validate(self):
        ...
        if not to__use__weighted__fitness:
            ...
            pprint_color(('map__id_class__to__weight', map__id_class__to__weight))
            pprint_color(('list__weight__metric', list__weight__metric))
            pprint_color(('metrics__details__by__id_class', metrics__details__by__id_class))
            pprint_color(('fitness', fitness))
