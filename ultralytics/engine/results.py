...
class BaseTensor(SimpleClass):
    ...
    def __init__(self, data: torch.Tensor | np.ndarray, orig_shape: tuple[int, int], **laptq_kwargs) -> None:
...
class Keypoints(BaseTensor):
    ...
    def __init__(self, keypoints: torch.Tensor | np.ndarray, orig_shape: tuple[int, int], **kwargs) -> None:
